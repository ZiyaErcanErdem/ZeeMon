...
export class ContentComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.contentService
      ...
      .subscribe(
        (res: HttpResponse<IContent[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInContents(): void {
    this.eventSubscriber = this.eventManager.subscribe('contentListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IContent[] | null, headers: HttpHeaders, page: number): void {
