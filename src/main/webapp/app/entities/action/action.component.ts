...
export class ActionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.actionService
      ...
      .subscribe(
        (res: HttpResponse<IAction[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInActions(): void {
    this.eventSubscriber = this.eventManager.subscribe('actionListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAction[] | null, headers: HttpHeaders, page: number): void {
