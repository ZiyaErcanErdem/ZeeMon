...
public class ScriptParam implements Serializable {
    ...
    @NotNull
    @JsonIgnoreProperties("scriptParams")
    ...
    public ScriptParam paramName(String paramName) {
    ...
    public ScriptParam paramDataType(DataType paramDataType) {
    ...
    public ScriptParam paramValue(String paramValue) {
    ...
    public ScriptParam paramExpression(String paramExpression) {
    ...
    public ScriptParam checkScript(CheckScript checkScript) {
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(((ScriptParam) o).id);
    }
