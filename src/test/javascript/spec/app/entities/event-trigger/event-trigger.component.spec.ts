...
import { EventTriggerComponent } from 'app/entities/event-trigger/event-trigger.component';
...
describe('Component Tests', () => {
  describe('EventTrigger Management Component', () => {
    let comp: EventTriggerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EventTriggerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.eventTriggers && comp.eventTriggers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
